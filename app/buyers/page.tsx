        ...
        <div className="card">
          <div className="page-header">
            <div>
              ...
              <p className="page-header-subtitle">Manage your buyer leads and publishing status</p>
            </div>
            <div className="btn-group">
              <Link href="/" className="btn btn-success">View Live Site</Link>
              <Link href="/buyers/new" className="btn btn-primary">Add New Buyer</Link>
            </div>
          </div>
          <h2 className="page-header-subtitle" style={{ marginBottom: '1rem' }}>All Buyers</h2>
